...
- `11 min` | 📄🧰 | [Yearly planning meetings: individualized development plans...](https://doi.org/10.1016/j.molcel.2015.04.025) - Using yearly PI–trainee meetings to set goals, give feedback, and support trainees’ research and career development.
...
- `  ----  ` | 🧰 | [Example group websites](pages/research-group-websites.md) - A collection of noteworthy research group websites. 
...
- `05 min` | 📑 | [EMBO Press Figure Guidelines](https://www.embopress.org/pb-assets/embo-site/EMBOPress_Figure_Guidelines_061115.pdf) - Technical requirements and layout dimensions.
- `05 min` | 📑 | [Nature Figure Guidelines](https://www.nature.com/documents/Final_guide_to_authors.pdf) - Technical requirements and layout dimensions.
...
- `  ----  ` | 🧰 | [Color Oracle Software](https://colororacle.org/) - Free color blindness simulator for Windows, Mac and Linux
- `  ----  ` | 🧰 | [Figures: fonts, sizing, dimensions, linewidth...](pages/figure-fonts-sizing.md) - Figure parameters that satisfy most journals.
- `  ----  ` | 🧰 | [Find the graphic you need](https://www.data-to-viz.com/) - Classification of all possible chart types.
- `  ----  ` | 🧰 | [The Data Visualisation Catalogue](https://datavizcatalogue.com/) - Guide and library of different data visualizations.
...
- `  ----  ` | 🧰 | [CV/Resume parser](https://www.open-resume.com/resume-parser/) - Check how your resume will be recognized by automatic company systems. 
